...
class KMeansClustering:
    ...
    def elbow_plot(self, data):
        """
                        ...
                        """
        self.logger_object.log(self.file_object, "Entered the elbow method of the KMeansClustering class")
        wcss = [ ]
        try:
            for i in range(1, 11):
            ...
            self.logger_object.log(self.file_object, "The optimum number of cluster is: " + str(
    ...
    def create_clusters(self, data, number_of_clusters):
        ...
        try:
            ...
            # passing "Model" as the functions nees three parameters

            self.data[ 'Cluster' ] = self.y_kmeans  # create a new column in dataset for storing the cluster information
            self.logger_object.log(self.file_object, "Successfully created " + str(
                    self.kn.knee) + " cluster. Exited the create_clusters method of the KmeansClustrin class")
            return self.data
        except Exception as e:
            self.logger_object.log(self.file_object,
