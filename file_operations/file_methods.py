...
class File_Operation:
    ...
    def save_model(self, model, filename):
        ...
        self.logger_object.log(self.file_object,
                               "Entered the save_model method of the File_Operation class to save the model")
        try:
            path = os.path.join(self.model_directory, filename)  # create sepearte directory for each cluster
    ...
    def load_model(self, filename):
        """
                ...
                """
        self.logger_object.log(self.file_object,
                               "Entered the load_model method of the File_Operations class for loading the model")
        try:
    ...
    def find_correct_model_file(self, cluster_number):
        """
                        ...
                        """
        self.logger_object.log(self.file_object,
                               "Entered the find_correct_model_file method of the File_Operation class for finding the correct model")
        try:
